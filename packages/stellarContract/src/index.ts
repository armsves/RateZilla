...
export const networks = {
  testnet: {
    ...
    contractId: "CAZH5SRKC6S5K7KW4IXXYPMIXDDT33VS6JPXHHCDPLBMUEQ7O2523ZCS",
  }
} as const
...
export interface Client {
   ...
   */
  edit_message: ({message_id, title, text}: {message_id: u32, title: string, text: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
